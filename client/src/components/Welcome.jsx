    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
          <h1 className="3xl sm:text-5xl text-white text-gradient py-1">Send Crypto <br /> internationally</h1>
          <p className="text-white mt-5 text-left font-light md:w-9/12 w-11/12 text-base">
            Explore crypto... buy and sell crypto with ease on Krypt...
          </p>
          {!connectedAccount && 
            <button 
            type="button" 
          ...
          <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
            <div className="p-3 flex justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card .white-glassmorphism">
              <div className="flex justify-between flex-col w-full h-full">
                ...
                <div>
                  <p className="text-white font-light text-sm">{connectedAccount? shortenAddress(connectedAccount): "Address"}</p>
